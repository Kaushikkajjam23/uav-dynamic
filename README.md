...
This repository implements real-time conflict-free path planning algorithms for multiple UAVs using improved 
versions of Hybrid A* and RRT (Rapidly-exploring Random Tree) algorithms. The project provides both 2D (main branch) and 3D (threeD branch) simulation environments.
Author
Kaushik Kajjam
Requirements
# requirements.txt
...
Add realistic UAV dynamics constraints how to add this to github repo as readme file give iwth proper ifdentation adn highlights 
